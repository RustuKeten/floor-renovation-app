...
export function MaterialSelector() {
  const { selectedMaterial, setSelectedMaterial, getTotalSqFt, setStep } =
    useFloorStore();
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-400 max-w-xl">
            Select the perfect flooring material for your{" "}
            {totalSqFt.toLocaleString()} sq ft space. Prices include materials
...
function MaterialCard({
  ...
  const totalPrice =
    (material.pricePerSqFt + material.laborPerSqFt) * totalSqFt;
