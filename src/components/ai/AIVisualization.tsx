...
const MATERIAL_OVERLAYS: Record<string, { gradient: string; blend: string }> = {
  ...
  "porcelain-tile": {
    gradient:
      "linear-gradient(135deg, rgba(236,239,241,0.4) 0%, rgba(176,190,197,0.5) 50%, rgba(236,239,241,0.4) 100%)",
    blend: "overlay",
  },
  "ceramic-tile": {
    gradient:
  ...
  "luxury-vinyl": {
    gradient:
      "linear-gradient(135deg, rgba(188,170,164,0.5) 0%, rgba(121,85,72,0.5) 50%, rgba(188,170,164,0.5) 100%)",
    blend: "multiply",
  },
};
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-violet-200">
                <strong>AI-Generated Estimate:</strong> This visualization and
                measurements are estimates based on image analysis. For accurate
                pricing, we recommend a professional in-person measurement.
              </p>
            </div>
          </div>
        </motion.div>
